            ...
            <div>
                {
                    templates.map(template => (
                        <button
                            ...
                            className={`px-4 py-2 rounded-md text-sm font-semibold transition ${selected === template ? "bg-indigo-600 text-white" : "bg-gray-800 text-gray-300 hover:bg-gray-700"}`}
                        >
